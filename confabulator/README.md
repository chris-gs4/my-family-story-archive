...
# 1. Merge epic #1
git merge epic/1-user-management

# 2. Merge task #3
#    (depends on: #2)
git merge task/3-implement-user-login

# 3. Merge epic #4
#    (depends on: #8)
git merge epic/4-ai-guided-interviews

# 4. Merge task #6
git merge task/6-implement-real-time-question-adaptation

# 5. Merge epic #7
git merge epic/7-transcription-and-narrative-generation
...
- [GitHub Issues](https://github.com/chris-squeff/my-family-story-archive/issues) - View all issues with detailed requirements
