      ...
      <section className="relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 pt-16 pb-12 text-center">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: '#3d3d3d' }}>
            Everyone has a story worth preserving, but writing is intimidating.
            <strong style={{ color: '#2F6F5E' }}> Mabel removes the blank page.</strong>
            {' '}Just talk &mdash; she listens, transcribes, and transforms your
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-6">
            ...
            {/* OR divider - visible on desktop only */}
            ...
            {/* QR Code */}
            <QRCodeCTA
              url={typeof window !== 'undefined' ? window.location.origin : 'https://mabel.app'}
      ...
      <section className="py-16 px-6" style={{ backgroundColor: 'rgba(47, 111, 94, 0.04)' }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed" style={{ color: 'rgba(17, 24, 39, 0.7)' }}>
            <strong style={{ color: '#2F6F5E' }}>Writing feels like homework.</strong> Staring at a blank page is
            intimidating. That&apos;s why most people never start. Mabel changes that &mdash; no writing
            skills needed, just your voice and your memories.
          </p>
        </div>
      </section>
