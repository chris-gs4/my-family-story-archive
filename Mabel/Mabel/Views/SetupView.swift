            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextField("Enter their name", text: $setupData.name)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 12)
                                .strokeBorder(Color.mabelSubtle.opacity(0.3), lineWidth: 1)
                        )
                }
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    Button(action: {
                        ...
                        HStack(spacing: 6) {
                            Image(systemName: setupData.isFreeJournaling ? "checkmark.circle.fill" : "circle")
                                .font(.system(size: 16))
                                .foregroundColor(setupData.isFreeJournaling ? .mabelTeal : .mabelSubtle)
