...
- **2026-05-04 — Regeneration prompt drifts from 3rd to 1st person.** Tested with "Make it shorter and add more emotion" on Chapter 3. The regenerated narrative honored "more emotion" beautifully (richer language, sensory verbs, first-person interiority) but **switched the narrative voice from 3rd person to 1st person** without being asked. Original: *"Margaret's inner world began to bloom."* Regenerated: *"my world began to bloom."* This may be a system-prompt issue in `OpenAIService.regenerateChapterNarrative()` — needs to enforce voice consistency with the original or with `UserProfile.relationship` (storyteller-voice vs. 3rd-person biographer). Also: "shorter" may not have been honored visibly — confirm by length comparison. Phase 2 prompt-engineering work should address voice locking.
