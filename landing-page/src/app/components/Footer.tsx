export default function Footer() {
  return (
    <footer>
      ...
      <div className="border-t border-[rgba(0,0,0,0.08)] bg-mabel-bg-alt px-6 py-8">
        <div className="mx-auto flex max-w-6xl items-center justify-center gap-6">
          <a
            href="https://instagram.com/trymabelapp"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow Mabel on Instagram"
            className="text-[#2d2c2b] transition-colors hover:text-[#2E7D6B]"
          >
          ...
          <a
            href="https://tiktok.com/@trymabelapp"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow Mabel on TikTok"
            className="text-[#2d2c2b] transition-colors hover:text-[#2E7D6B]"
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            href="https://youtube.com/@trymabelapp"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow Mabel on YouTube"
            className="text-[#2d2c2b] transition-colors hover:text-[#2E7D6B]"
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            href="https://facebook.com/trymabelapp"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow Mabel on Facebook"
            className="text-[#2d2c2b] transition-colors hover:text-[#2E7D6B]"
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
